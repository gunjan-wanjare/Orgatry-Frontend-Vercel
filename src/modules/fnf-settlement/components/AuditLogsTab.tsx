  ...
  return (
    <SectionCard title="Audit & System Logs">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <Field label="Case ID / SRN" value={settlement.auditLogs?.caseId ?? settlement.caseId} />
        <Field label="SRN" value={settlement.auditLogs?.srn} />
        ...
        <div className="md:col-span-3">
          ...
          <p className="mt-1 text-sm">{settlement.auditLogs?.versionHistory ?? "-"}</p>
        </div>
        <div className="md:col-span-3">
