...
function Calendar({
  ...
  return (
    <DayPicker
      hideWeekdays={true} // For modern versions of react-day-picker
      ...
      classNames={{
        ...
        head_row: "hidden", // Completely hide the header structure via CSS if it renders
        head_cell: "hidden", // Hide individual day headers just in case
